...
def main():
    ...
    parser.add_argument('-f', '--function-name', dest='function_name', help='The function to call after DllMain', default='run')
    parser.add_argument('-u', '--user-data', dest='user_data', help='Data to pass to the target function', default='')
